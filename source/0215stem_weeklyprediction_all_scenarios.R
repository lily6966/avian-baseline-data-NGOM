...
# 1
# ----------------------------------------------
species_collection1<-species <- c("ameavo","amgplo", "bknsti", "dunlin", "lobdow", "margod","mouplo", "lobcur", "leasan", "lesyel", "killde", "greyel","pecsan", "uplsan","shbdow", "whimbr")

scenarios<-c("dust","eem", "bbau", "dream")
...
habitat_crop <- read_csv("data/pland-elev_nort_east_canopy_location-10year_checklist_greyel.csv") %>% 
...
#   width = c(0.3, 0.3, 0.08),
#   n = 10,
#   baseModel = GBM_train, 
#   # No BaseModel parameters
#   # BaseModel parameters
#   bm.formula = "observation_count ~ canopy+year+day_of_year+time_observations_started+duration_minutes+
#     effort_distance_km+number_observers+time_observations_started+field_row+rice+perennial+pasture+grain+elevation_median+elevation_sd+
...
# prediction surface
pred_surface_count <- read_csv(paste0("data/pland-elev_nort_east_canopy_prediction-surface_pmp_", scenario, "_lucas.csv"))
